$(function () {
  ...
  $(".pro>.img-mask").mouseover(function () {
    ...
    $(window).scroll(function () {
        ...
        // if ($(document).scrollTop() > $(".year-left-2010").offset().top-500) {
        //     $(".year-left-2010").animate({"right":"10px","opacity":1}, 1000);
        // }
        //
        // 特殊的
        ...
        // if ($(document).scrollTop() > $(".pro-sp1").offset().top-500) {
        //     $(".pro-sp1").addClass("pro2")
        //     $(".pro-sp1").addClass("pro2")
        //     $(".sidebar>ul>li:eq(9)").addClass("current").siblings("li").removeClass("current");
        //     console.log($(".pro-sp1").offset().top);
        // }
        // if ($(document).scrollTop() > $(".pro-sp2").offset().top-500) {
        //     $(".pro-sp2").addClass("pro2")
        //     $(".pro-sp2").addClass("pro2")
        //     $(".sidebar>ul>li:eq(10)").addClass("current").siblings("li").removeClass("current");
        //
        // }
    });
     //  返回顶部
