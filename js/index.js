...
function createNav() {
    // 数据
    var ullis = [
        {"link": "javascript:;", "name": "游戏公告", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "游戏特色", "targettype": "_blank", "else": ""},
        ...
        {"link": "javascript:;", "name": "官方论坛", "targettype": "_blank", "else": ""},
    ]
    var spegame1 = [
        {"link": "javascript:;", "name": "最新消息", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "官方新闻", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "游戏公告", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "热点活动", "targettype": "_blank", "else": ""}
    ];
    var spegame2 = [
        ...
        {"link": "geographyRec.html", "name": "国风地理志", "targettype": "_blank", "else": ""},
    ]
    var spegame3 = [
        {"link": "newGuide.html", "name": "新手指南", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "进阶攻略", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "精彩战报", "targettype": "_blank", "else": ""},
    ]
    var spegame4 = [
        {"link": "javascript:;", "name": "藏宝阁", "targettype": "_blank", "else": ""},
        {"link": "heroList.html", "name": "天下英雄榜", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "天下百科", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "天下知道", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "合服查询", "targettype": "_blank", "else": ""},
    ]
    var spegame5 = [
        ...
        {"link": "javascript:;", "name": "天下小说", "targettype": "_blank", "else": ""},
    ]
    var spegame6 = [
    ...
    var spegame7 = [
        {"link": "javascript:;", "name": "在线客服", "targettype": "_blank", "else": ""},
        {"link": "javascript:;", "name": "心意服务", "targettype": "_blank", "else": ""}
    ]
    var spegame8 = []
    var spe = [
